...
namespace foodOrderingSystem.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(FoodOrderingSystemContext context)
        {
            _context = context;
        }
        ...
        {
            var foodOrderingSystemContext = _context.Payments.Include(p => p.Customer);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FoodOrderingSystemContext.Payments'  is null.");
            }
            var payment = await _context.Payments.FindAsync(id);
            if (payment != null)
            {
